        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-8">
          {data?.map((product) => (
            ...
            >
              ...
              <button onClick={() => navigate(`/productDetails/${product.id}`)} className="h-[40px] w-full border border-violet-800 rounded-[10px] shadow-[0px_2px_8px_3px_#360564] hover:bg-violet-800 duration-300 cursor-pointer">See More</button>
            </div>
          ))}
        </div>
      )}
